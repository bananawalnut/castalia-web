...
const navigationDestinations = [
  ...
  [
    "Chronicle",
    "/chronicle",
    "Implemented read-only essay about portable encrypted data and the planned Castaway vault.",
  ],
  [
    "Tenders",
    "/tenders",
