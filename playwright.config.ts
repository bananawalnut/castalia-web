...
export default defineConfig({
  ...
  webServer: {
    command: `VITE_APP_ENV=test VITE_FIXTURE_MODE=true VITE_CASTALIA_CONTROL_BASE_URL=${browserOrigin} pnpm --filter @castalia/web build && VITE_FIXTURE_MODE=true pnpm --filter @castalia/web exec vite preview --host 127.0.0.1 --port ${browserPort} --strictPort`,
    url: browserOrigin,
